...
Справка по zip, создание каталога(рис. @fig:001).

![Справка по zip, создание каталога](image/1.png){#fig:001 width=70%}

Первый скрипт(рис. @fig:002).

![Первый скрипт](image/2.png){#fig:002 width=70%}

Работа первого скрипта (рис. @fig:003).
...
Сам скрипт. (рис. @fig:004).

![Второй скрипт](image/4.png){#fig:004 width=70%}

Работа второго скрипта (рис. @fig:005).
...
Третий скрипт. (рис. @fig:006).

![Третий скрипт](image/6.png){#fig:006 width=70%}

Работа третьего скрипта (рис. @fig:007).
...
Четвертый скрипт. (рис. @fig:008).

![Четвертый скрипт](image/8.png){#fig:008 width=70%}

Работа четвертого скрипта (рис. @fig:009).
...
омандный процессор (командная оболочка, интерпретатор команд shell) — это программа, позволяющая пользователю взаимодействовать с операционной системой компьютера. В операционных системах типа UNIX/Linux наиболее часто используются следующие реализации командных оболочек:
